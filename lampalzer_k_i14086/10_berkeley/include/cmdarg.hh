...
public:
  ...
  CmdArg(const char, const char*,  char*, char*, unsigned int = (isREQ | isVALREQ));
  virtual ~CmdArg();
...
public:
  CmdArgInt(const char, const char*, char*, char*, unsigned int = (isREQ | isVALREQ),
	    int = 0);
  ~CmdArgInt();
...
public:
  CmdArgFloat(const char, const char*, char*, char*, unsigned int = (isREQ | isVALREQ),
	      double = 0);
  ~CmdArgFloat();
...
public:
  CmdArgBool(const char, const char*, char*, unsigned int = (isREQ | isVALREQ));
  ~CmdArgBool();
...
public:
  CmdArgStr(const char, const char*, char*, char*, unsigned int = (isREQ | isVALREQ),
	    char* = NULL);
  ~CmdArgStr();
...
public:
  CmdArgChar(const char, const char*, char*, char*, unsigned int = (isREQ | isVALREQ),
	     char = '\0');
  ~CmdArgChar();
...
public:
  ...
  typedef ArgList::iterator ArgListIterator;
...
{
  CmdArgTypeList<T>::ArgList::const_iterator it;
  it = _list.begin();
  os << *it;
  it++;
  for (;it != _list.end(); it++) {
...
{
public:
  CmdArgIntList(const char, const char*, char*, char*, unsigned int = (isREQ | isVALREQ),
...
{
public:
  CmdArgFloatList(const char, const char*, char*, char*, unsigned int = (isREQ | isVALREQ),
		  int = 1, int = 100, const char* = ",~/");
  ~CmdArgFloatList();
...
{
public:
  CmdArgStrList(const char, const char*, char*, char*, unsigned int = (isREQ | isVALREQ),
		int = 1, int = 100, const char* = ",~/.-");
  ~CmdArgStrList();
...
{
public:
  CmdArgCharList(const char, const char*, char*, char*, unsigned int = (isREQ | isVALREQ),
		 int = 1, int = 100, const char* = ",~/.-");
  ~CmdArgCharList();
